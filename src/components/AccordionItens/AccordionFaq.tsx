            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} fontSize={"large"}>
                <Text textAlign={"justify"}>
                  ...
                  <strong>estratégia de marketing</strong>, uma Landing Page
                  pode te <strong>posicionar no Google</strong> e qualificar
                  ainda mais os Leads (clientes), através de{" "}
                  <strong>segmentações,</strong> uma forma de expandir o seu
                  negócio, serviço ou produto. Com um ótimo{" "}
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} fontSize={"large"}>
                <Text textAlign={"justify"}>
                  ...
                  existem diferenças entre Landing Page e site. Conforme
                  acabamos de explicar, a Landing Page tem a função de conversão
                  em leads, enquanto o site oferece conteúdo relevante para o
                  seu público.
                </Text>
                <br />
                <Text textAlign={"justify"}>
                  Portanto, dentro da sua estratégia digital, é importante que o
                  seu site tenha uma boa estrutura de SEO para que seja
                  encontrado nos motores de busca. Por isso, uma boa dica é que
                  a Landing Page seja divulgada em CTAs dentro do site, para
                  transformar os visitantes em leads.
                </Text>
                <Text textAlign={"left"} mt={2}>
                  Fonte:{" "}
                  <Link
